        ...
        <div>
          ...
          <div className="flex flex-col border rounded shadow m-1 p-2 items-center z-20 bg-white">
            ...
            <div className="flex mt-2 justify-around w-full text-gray-700 font-semibold z-20">
              <div
                className="rounded w-1/3 text-center py-1 px-3 border-green-900 border-2 cursor-pointer hover:shadow-inner hover:border-green-700 z-20"
                onClick={() => {
                  props.onYes();
                  props.hide();
                }}
              ...
              <div
                className="rounded w-1/3 text-center py-1 px-3 border-red-900 border-2 cursor-pointer hover:shadow-inner hover:border-red-700 z-20"
                onClick={() => props.hide()}
              >
                No
              </div>
